...
using static Aiva.Bot.ViewModels.Extension;
...
namespace Aiva.Bot.ViewModels {
        ...
        private void CreateModels() {
            Model = new Models.VotingModel {
                ...
                Text = new Models.VotingModel.TextModel {
                    VotingButtonStartText = LanguageConfig.Instance.GetString("VotingButtonStartText"),
                    VotingButtonStopText = LanguageConfig.Instance.GetString("VotingButtonStopText"),
                    VotingNameWatermarkText = LanguageConfig.Instance.GetString("VotingNameWatermarkText"),
                    VotingCommandWatermarkText = LanguageConfig.Instance.GetString("VotingCommandWatermarkText"),
                    VotingPieChatNameText = LanguageConfig.Instance.GetString("VotingPieChatNameText"),
                    VotingBarChartNameText = LanguageConfig.Instance.GetString("VotingBarChartNameText"),
                    VotingDoughnutChartNameText = LanguageConfig.Instance.GetString("VotingDoughnutChartNameText"),
                }
            };
        }
    ...
    public static class SwitchExtensions {
        public static Aiva.Bot.ViewModels.Extension.Switch<T> Case<T>(this Switch<T> switchObject, T type, Action<T> action) {
