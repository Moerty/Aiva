    ...
    public class SettingsViewModel
    {
        ...
        private void CreateModels()
        {
            Model = new Models.SettingsModel
            {
                ...
                {
                    Header = "Interactions",
                    Content = new Views.SettingsTabs.Interactions(),
                }
            }
            };
        }
            ...
            private void CreateModels()
            {
                Model = new Models.SettingsModel.InteractionModel
                {
                    ...
                    Text = new Models.SettingsModel.InteractionModel.TextModel
                    {
                        ...
                        InteractionTextboxSubPrimeWatermarkText = LanguageConfig.Instance.GetString("InteractionTextboxSubPrimeWatermarkText"),
                    }
                };
            }
        }
