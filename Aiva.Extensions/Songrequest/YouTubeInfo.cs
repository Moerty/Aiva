...
namespace Aiva.Extensions.Songrequest {
    public class YouTubeInfo {
        ...
        public async Task<Models.Songrequest.SongModel> GetVideoDetails() {
        ...
        private Models.Songrequest.SongModel GetSongModel(string result) {
            var songModel = new Models.Songrequest.SongModel();
